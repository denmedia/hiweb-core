...
////////////////////////////////////////////////////
    ...
    public function error($showBacktrace = false){
        static $class = null;
        if(!is_object($class) && file_exists(dirname(__FILE__).'/hiweb-core-error.php')) { require_once dirname(__FILE__).'/hiweb-core-error.php'; $class = new hiweb_error($showBacktrace); }
        return $class;
    }
...
//////////////////////////////////////////////////////
    ...
    public function debug($showBacktrace = false){
        ...
        $this->console()->warn('hiweb->debug включен : '. $this->file()->getStr_linkPath($this->array2()->getVal($debugBacktrace, array(0,'file'))).' : line:'.$this->array2()->getVal($debugBacktrace, array(0,'line')));
    }
